...
export const GET_SELECTED_CONVERSATION = 'forum/GET_SELECTED_CONVERSATION'
export const GET_THREADS = 'other/GET_THREADS'
export const GET_ACTIVE_FIXED_THREAD = 'forum/GET_ACTIVE_FIXED_THREAD'
...
export const DELETE_VOTE = 'forum/DELETE_VOTE'
...
export const SET_SELECTED_CONVERSATION = 'forum/SET_SELECTED_CONVERSATION'
export const SET_THREADS = 'forum/SET_THREADS'
export const SET_ACTIVE_FIXED_THREAD = 'forum/SET_ACTIVE_FIXED_THREAD'
