...
import { Poll, Chronicle, PollSelection, Region } from '../../model/other'
import { PollVote as CrudVote } from '../../model/other/crud'

import { SET_POLL, SET_POLLS, SET_CHRONICLES, SET_CHRONICLE, SET_VOTES_ON_POLL, SET_REGIONS } from './types'
