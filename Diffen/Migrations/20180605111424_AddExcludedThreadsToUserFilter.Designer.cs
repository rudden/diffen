...
namespace Diffen.Migrations
{
    ...
    [Migration("20180605111424_AddExcludedThreadsToUserFilter")]
    partial class AddExcludedThreadsToUserFilter
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Diffen.Database.Entities.Forum.PostToThread", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Diffen.Database.Entities.Forum.Thread", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Diffen.Database.Entities.Squad.Game", b =>
                {
                    ...
                    b.Property<int>("NumberOfAddonMinutes");
                    ...
                    b.Property<int>("TablePlacementAfterGame");
            ...
            modelBuilder.Entity("Diffen.Database.Entities.Squad.Season", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Diffen.Database.Entities.User.Filter", b =>
                {
                    ...
                    b.Property<string>("ExcludedThreadIds");
            ...
            modelBuilder.Entity("Diffen.Database.Entities.Forum.PostToThread", b =>
                {
                    ...
                    b.HasOne("Diffen.Database.Entities.Forum.Thread", "Thread")
                        .WithMany()
            ...
            modelBuilder.Entity("Diffen.Database.Entities.Squad.Game", b =>
                {
                    ...
                    b.HasOne("Diffen.Database.Entities.Squad.Season", "Season")
                        .WithMany("Games")
